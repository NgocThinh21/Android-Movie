                        ...
                        <div class="panel-body">
                            <div class="position-center">
                                ...
                                <div>
                                    ...
                                    <input type="file" name="mv_trailer"  id="exampleInputPassword1" enctype="multipart/form-data">
                                </div>
                              
                                <div class="form-group" enctype="multipart/form-data">
                                    <label for="exampleInputFile" enctype="multipart/form-data"> Hinh anh</label>
                                    <input type="file" name="mv_hinhanh"  id="exampleInputPassword1" enctype="multipart/form-data">
                                </div>
